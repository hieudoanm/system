...
System is a focused project in this monorepo that delivers a practical tool with a clean user experience across platforms.

## ✨ 2. Features

1. [x] Core functionality tailored to System
...
- 🌐 [Live Demo](https://hieudoanm.github.io/system/)

## 🚀 4. Usage

- 🌐 [Web](https://hieudoanm.github.io/system/)
- 💻 [CLI](https://github.com/hieudoanm/system/releases)
- 📱 [Mobile](https://github.com/hieudoanm/system/releases)
- 🖥️ [Desktop](https://github.com/hieudoanm/system/releases)
  - 🍎 [MacOS](https://github.com/hieudoanm/system/releases/tag/macos-latest)
  - 🐧 [Ubuntu](https://github.com/hieudoanm/system/releases/tag/ubuntu-latest)
  - 🪟 [Windows](https://github.com/hieudoanm/system/releases/tag/windows-latest)
